...
public class IbsCmsController {
	...
	public String memberJoin(@ModelAttribute MemberAccountDTO dto) throws NoSuchAlgorithmException, UnsupportedEncodingException, GeneralSecurityException, UnknownHostException {
		...
		if(affectcount!=0) {
			HanibalWebDev.sednEmail("hanibal@gmail.com",dto.getMember_email(),"SEDN 관리자 사이트 가입 인증번호 입니다.",mailBody);
		}
	...
	public String lostpass(@ModelAttribute MemberAccountDTO dto) {
		...
		if(affectcount!=0){
			HanibalWebDev.sednEmail("hanibal@gmail.com",dto.getMember_email(),"SEDN 관리자 임시 비밀번호 입니다.",mailBody);
		}
		return dto.getMember_email();
	}
	...
	public String statisticsMenu(@PathVariable String section, HttpServletRequest request, Model model) {
		...
		if(section.equals("vodDetail")) {
			...
			HashMap<String,Object> map= ibsCmsDao.statisticsVODDetail(idx);
	...
	public void getVODListData(@PathVariable String categoryIdx,HttpServletResponse res) throws IOException, JSONException {
		...
		List<HashMap<String,Object>> statisticsVODList=ibsCmsDao.statisticsVODList("", categoryIdx);
		res.setCharacterEncoding("utf8");
	...
	public ModelAndView getVODListDataPOST(HttpServletRequest request, HttpServletResponse res) throws IOException, JSONException {
		...
		List<HashMap<String,Object>> statisticsVODList=ibsCmsDao.statisticsVODList("", childIdx);
		res.setCharacterEncoding("utf8");
		jsonContents.put("contents", statisticsVODList);
